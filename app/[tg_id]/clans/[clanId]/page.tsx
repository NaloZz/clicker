...
const ClanPage = async ({
	...
	try {
		...
		const ref_text = `🏆+2.5k ULT100x as a first-time bonus
💎+50k ULT100x if you have Telegram Premium`;
		...
		return (
			<main className="min-h-screen flex flex-col p-4 pt-10 relative">
				<div className="flex flex-col items-center relative z-10">
					...
					{clan.description && (
    <p className="text-[15px] leading-none mt-8 text-center">
    You are now in the clan. <br />
    Invite friends and burn more!
</p>
